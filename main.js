...
function my_keydown(e)
{
	...
	function up()
	{
		...
		if (ball_y>=5){
			...
			console.log("block_image_heigth= " +block_image_height);
			console.log("Cuando up es presionado, x= "+ball_x+" , y= "+ball_y);
			canvas.remove(ball_obj);
			new_image();
		}
	}
	...
	function down()
	{
		 ...
		 if (ball_y<=450){
			ball_y= ball_y + block_image_height;
			console.log("block_image_heigth= " +block_image_height);
			console.log("Cuando down es presionado, x= "+ball_x+" , y= "+ball_y);
			canvas.remove(ball_obj);
			new_image();
		}
	}
	...
	function left()
	{
		if(ball_x >5)
		{
			// Escribe el código para mover la pelota hacia la izquierda.
				...
				console.log("Cuando left es presionado, x= "+ball_x+" , y= "+ball_y);
				canvas.remove(ball_obj);
				new_image();
		}
	}
	...
	function right()
	{
		if(ball_x <=1050)
		{
			// Escribe el código para mover la pelota hacia la derecha.
				ball_x= ball_x + block_image_width;
				console.log("block_image_width= " +block_image_width);
				console.log("Cuando right es presionado, x= "+ball_x+" , y= "+ball_y);
				canvas.remove(ball_obj);
				new_image();
		}
	}
